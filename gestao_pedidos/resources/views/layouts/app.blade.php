...
<head>
    ...
    <title>@yield('title', 'Gestão de Pedidos')</title>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container-fluid">
            <a class="navbar-brand" href="{{ route('dashboard') }}">
                <i class="bi bi-shop"></i> Gestão de Pedidos
            </a>
    ...
    <footer class="bg-light text-center py-3 mt-5">
        <div class="container">
            <span class="text-muted">&copy; {{ date('Y') }} Gestão de Pedidos - Sistema de Salgados</span>
        </div>
    </footer>
